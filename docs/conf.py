...
project = 'RPi-SmartGadget'
copyright = smartgadget.__copyright__[1:]
author = smartgadget.__author__
...
htmlhelp_basename = 'RPi-SmartGadgetdoc'
...
latex_documents = [
    (master_doc, 'RPi-SmartGadget.tex', 'RPi-SmartGadget Documentation',
...
man_pages = [
    (master_doc, 'RPi-SmartGadget', 'RPi-SmartGadget Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RPi-SmartGadget', 'RPi-SmartGadget Documentation',
     author, 'RPi-SmartGadget', 'Communicate with a Sensirion SHTxx Smart Gadget',
     'Miscellaneous'),
]
